def call(){
  ...
  */ 
   ...
   echo targetMailId
       ...
       emailext attachLog: true, body: bodyTemplate, compressLog: true, subject: 'Jenkins Build Completed', to: 'brahmendra.jayaraju@ge.com,Raghavendra.Jahagirdar@ge.com,Ashutosh.Pattanaik@ge.com', from: 'JenkinsAlert@ge.com'
}
