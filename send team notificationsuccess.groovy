...
def sendTeamsNotification() {
    String buildResult = "${currentBuild.getCurrentResult().toLowerCase()}"
    String buildResultEmoji = ""
    String buildMessageTextStyle = ""
    switch (buildResult){
        case "success": buildResultEmoji = "✔"; buildMessageTextStyle = "Good"; break;
        case "unstable": buildResultEmoji = "⚠"; buildMessageTextStyle = "Warning"; break;
        case "failure": buildResultEmoji = "❌"; buildMessageTextStyle = "Attention"; break;
        case "aborted": buildResultEmoji = "✋⛔"; buildMessageTextStyle = "Accent"; break;
        default: buildResultEmoji = "😐"; buildMessageTextStyle = "Dark";
    }
    
    String buildMessage =  "Build " + buildResult.replaceFirst(buildResult[0], buildResult[0].toUpperCase()) + " " + buildResultEmoji
